...
require 'thefox-ext/range/lexer2/block'
require 'thefox-ext/range/lexer2/block_down'
require 'thefox-ext/range/lexer2/block_up'
require 'thefox-ext/range/lexer2/operator'
